...
static std::unique_ptr<jit::JITImpl> jit_compiler = std::make_unique<jit::JITImpl>();
...
void execute_jalr(const DecodedInstruction instr, Hart& hart) {
    ...
    hart.set_next_pc(_tmp60_val);
        if(jit_compiler->is_compiled(_tmp60_val)) {
            jit_compiler->run_compiled(_tmp60_val);
        } else {
            jit_compiler->increase_access_rate_and_compile_if_ready(_tmp60_val, hart);
        }
    hart.set_reg(instr.rd, rd_val);
}
...
void execute_beq(const DecodedInstruction instr, Hart& hart) {
    ...
    if (_tmp61_val) {
        ...
        if(jit_compiler->is_compiled(_tmp62_val)) {
            jit_compiler->run_compiled(_tmp62_val);
        } else {
            jit_compiler->increase_access_rate_and_compile_if_ready(_tmp62_val, hart);
        }
    }
}
...
void execute_bne(const DecodedInstruction instr, Hart& hart) {
    ...
    if (_tmp63_val) {
        ...
        if(jit_compiler->is_compiled(_tmp64_val)) {
            jit_compiler->run_compiled(_tmp64_val);
        } else {
            jit_compiler->increase_access_rate_and_compile_if_ready(_tmp64_val, hart);
        }
    }
}
...
void execute_blt(const DecodedInstruction instr, Hart& hart) {
    ...
    if (_tmp65_val) {
        ...
        if(jit_compiler->is_compiled(_tmp66_val)) {
            jit_compiler->run_compiled(_tmp66_val);
        } else {
            jit_compiler->increase_access_rate_and_compile_if_ready(_tmp66_val, hart);
        }
    }
}
...
void execute_bge(const DecodedInstruction instr, Hart& hart) {
    ...
    if (_tmp69_val) {
        ...
        if(jit_compiler->is_compiled(_tmp70_val)) {
            jit_compiler->run_compiled(_tmp70_val);
        } else {
            jit_compiler->increase_access_rate_and_compile_if_ready(_tmp70_val, hart);
        }
    }
}
...
void execute_bltu(const DecodedInstruction instr, Hart& hart) {
    ...
    if (_tmp71_val) {
        ...
        if(jit_compiler->is_compiled(_tmp72_val)) {
            jit_compiler->run_compiled(_tmp72_val);
        } else {
            jit_compiler->increase_access_rate_and_compile_if_ready(_tmp72_val, hart);
        }
    }
}
...
void execute_bgeu(const DecodedInstruction instr, Hart& hart) {
    ...
    if (_tmp75_val) {
        ...
        if(jit_compiler->is_compiled(_tmp76_val)) {
            jit_compiler->run_compiled(_tmp76_val);
        } else {
            jit_compiler->increase_access_rate_and_compile_if_ready(_tmp76_val, hart);
        }
    }
}
...
void execute_jal(const DecodedInstruction instr, Hart& hart) {
    ...
    hart.set_next_pc(_tmp84_val);
        if(jit_compiler->is_compiled(_tmp84_val)) {
            jit_compiler->run_compiled(_tmp84_val);
        } else {
            jit_compiler->increase_access_rate_and_compile_if_ready(_tmp84_val, hart);
        }
    hart.set_reg(instr.rd, rd_val);
}
